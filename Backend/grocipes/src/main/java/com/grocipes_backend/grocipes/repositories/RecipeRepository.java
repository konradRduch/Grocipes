...
public interface RecipeRepository extends JpaRepository<Recipe, Integer> {
    ...
    @Query("SELECT (r.id,r.title,r.description,r.preparation_method,r.image_url,p.id,p.name,p.weight, p.price,p.image_url,p.calories,rp.quantity,urp.id, urp.name) " +
